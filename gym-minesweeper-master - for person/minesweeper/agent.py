...
def run_agent_game():
    ...
    while not done:    
        ...
        # What to do if STUCK
        #   If: game is 'done' (win/lose).
        #       agent is "stuck" (no more simple moves found).
        
        if not done:
            # stuck!
            print("\n--- AGENT STUCK ---")
            print("No more simple 'safe' or 'flag' moves found")
            
            # What to do now?
            # Current solution: nothing
            # Future improvements could include:
            #   - Make a random guess from remaining CLOSED cells
            #   - Use more complex probabilistic logic
            
            print("Agent is stopping")
            break # Exit the main 'while not done' loop
